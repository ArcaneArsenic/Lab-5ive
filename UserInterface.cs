...
namespace Ksu.Cis300.TextEditor
{
    ...
    public partial class UserInterface : Form
    {
        ...
        private void uxUndo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string a = (string)u.Pop();
                string b = (string)u.Pop();
                string c = (string)u.Pop();

                Stack undoHist = new Stack();
            ...
            { MessageBox.Show("An " + ex + " Error has occured"); }

           

        }

        private void DoEdit(TextBox uxEditBuffer)
        {
        ...
        private void uxRedo_Click(object sender, EventArgs e)
        {
            ...
            Stack editHist = new Stack();
            int x = (int)undoHist.Peek();
